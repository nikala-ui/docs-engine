...
export const defaultMdxComponents = {
  ...
  Container, Pager, PagerLink, Callout, Badge, Button, Plus, AspectRatio, Avatar, AvatarImage, AvatarFallback, Banner, Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbPage, BreadcrumbSeparator, BreadcrumbEllipsis, Bubble, BubbleGroup, BubbleContent, BubbleReactions, BubbleReaction, ComponentViewer, ApiTable,
